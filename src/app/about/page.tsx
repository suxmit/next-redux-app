...
export const metadata = {
  ...
  description: 'Our Journey from Shree Subh Agro & Organic to a globally trusted Indian agricultural export company.',
};
  ...
  return (
    <div className="min-h-screen font-sans text-charcoal bg-white pt-24 sm:pt-32 pb-20">
      ...
      <section className="max-w-4xl mx-auto px-6 mb-24">
        <div className="flex flex-col gap-6 text-lg text-charcoal/80 leading-relaxed font-light text-justify sm:text-left">
            <p>
                <strong className="font-semibold text-forest">LUXAGRO TAUREA</strong> is the evolution of a long-standing agricultural journey rooted in hands-on farming and domestic distribution across India. Our story began under the name <strong>Shree Subh Agro & Organic</strong>, through which we supplied agricultural and organic products to markets across the country with a strong focus on quality, reliability, and ethical practices.
            </p>
            <p>
                Operating nationally for many years, we were directly involved in cultivation, sourcing, and distribution. This experience helped us develop a deep understanding of farming practices, crop quality, seasonal cycles, and the importance of maintaining consistent standards from farm to market. Through <span className="font-medium text-forest">Shree Subh Agro & Organic</span>, we built trusted relationships with farmers, suppliers, and domestic buyers, establishing a solid reputation within India.
            </p>
            <p>
                As our vision grew beyond national boundaries, we transitioned into <strong>LUXAGRO TAUREA</strong> — a brand created to represent our global ambitions while carrying forward the same values and agricultural heritage. Under this new identity, we are expanding into international markets, bringing premium Indian agricultural and allied products to buyers worldwide.
            </p>
            <p>
                By combining traditional agricultural knowledge with modern processing, packaging, and export logistics, LUXAGRO TAUREA is committed to delivering quality, traceability, and reliability that meet global expectations. Our journey reflects a natural progression — from serving India with trust to serving the world with excellence.
            </p>
            <p className="text-2xl font-serif text-forest mt-8 text-center italic leading-relaxed px-4 border-l-4 border-gold bg-ivory/30 py-6 rounded-r-md">
                "From Shree Subh Agro & Organic to LUXAGRO TAUREA, our purpose remains unchanged: to respect our farming legacy and responsibly bring the work of Indian farmers to global tables."
            </p>
        </div>
      </section>
