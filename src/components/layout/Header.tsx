      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-white/40 backdrop-blur-md backdrop-saturate-150 border-b border-white/50 shadow-[0_8px_32px_0_rgba(0,0,0,0.05)] transition-all">
        <div className="bg-forest text-white/90 py-2 sm:py-2">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
             <div className="flex items-center justify-center sm:justify-between text-[10px] sm:text-xs md:text-sm">
                <div className="hidden sm:block font-medium tracking-wide">
                  Premium Agricultural Exports from India
                </div>
                <div className="flex items-center gap-10 sm:gap-8 justify-center w-full sm:w-auto">
                   <a href="tel:+919876543210" className="flex items-center gap-2 hover:text-gold transition-colors p-1 sm:p-0">
                   ...
                   <a href="mailto:export@luxagrotaurea.com" className="flex items-center gap-2 hover:text-gold transition-colors p-1 sm:p-0">
                     <svg className="h-4 w-4 sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                     </svg>
                     <span className="hidden sm:inline">export@luxagrotaurea.com</span>
                   </a>
                </div>
             </div>
          </div>
